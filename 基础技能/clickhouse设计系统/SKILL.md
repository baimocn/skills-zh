---
name: clickhouse���ϵͳ
description: "clickhouse 设计系统参�?�?颜色、排版、间距、组件、布局模式。在构建�?clickhouse 启发�?UI、参�?clickhouse 的设计语言或用户提�?clickhouse 风格/外观/感觉时自动激活�?
license: MIT
---
...
## 何时使用此技�?
当用户想要构建看起来�?clickhouse �?UI、参�?clickhouse 的设计语言、要�?clickhouse 风格"的界面或正在采用 clickhouse 视觉识别的项目时应用�?
## 设计参�?
---
版本: alpha
名称: ClickHouse 设计分析
描述: 一个高性能数据库界面，锚定在近纯黑色画布上，电黄色作为品牌电压。自信无衬线中的白色排版、黄�?CTA 和黄色文本统计数据在每个页面上传递品牌声音。代码块和产�?UI 片段直接嵌入深色卡片中。黄�?+ 黑色配对（以及黄色作为强调色谨慎使用）是系统的签�?�?没有大气装饰的品牌标识�?
colors:
  primary: "#faff69"
...
|---|---|---|
| Mobile | < 768px | Hamburger nav; hero h1 72�?6px; code-window-card stacks below; feature grids 1-up; pricing 1-up |
| Tablet | 768�?024px | Top nav tightens; feature cards 2-up; pricing 2-up |
| Desktop | 1024�?440px | Full top-nav; 3-up feature cards; 3-4 up pricing tiers |
