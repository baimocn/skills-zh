---
name: kraken���ϵͳ
description: "kraken 设计系统参�?�?颜色、排版、间距、组件、布局模式。在构建�?kraken 启发�?UI、参�?kraken 的设计语言或用户提�?kraken 风格/外观/感觉时自动激活�?
license: MIT
---
...
## 何时使用此技�?
当用户想要构建看起来�?kraken �?UI、参�?kraken 的设计语言、要�?kraken 风格"的界面或正在采用 kraken 视觉识别的项目时应用�?
## 设计参�?
# �?Kraken 启发的设计系�?
## 1. 视觉主题和氛�?
Kraken 的网站是一个干净、值得信赖的加密货币交易所，使用紫色作为其指挥品牌颜色。设计在白色背景上运行，Kraken Purple（`#7132f5`、`#5741d8`、`#5b1ecf`）创建独特的专业加密身份。专有的 Kraken-Brand 字体处理显示标题，粗体（700）权重和负跟踪，�?Kraken-Product（带�?IBM Plex Sans 后备）作�?UI 主力�?
**Key Characteristics:**
...
| Button | Kraken-Product | 16px | 500�?00 | 1.38 | normal |
| Caption | Kraken-Product | 14px | 400�?00 | 1.43�?.71 | normal |
| Small | Kraken-Product | 12px | 400�?00 | 1.33 | normal |
