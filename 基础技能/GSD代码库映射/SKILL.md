...
<flags>
- **--fast**: Lightweight scan mode 鈥?spawns one mapper agent instead of four. Accepts an optional `--focus` value: `tech`, `arch`, `quality`, `concerns`, or `tech+arch` (default). Faster and lower-context than the full map.
...
- **(no flag)**: Full parallel map 鈥?spawns 4 mapper agents to produce all 7 codebase documents.
</flags>
...
3. Spawn 4 parallel gsd-codebase-mapper agents:
   - Agent 1: tech focus 鈫?writes STACK.md, INTEGRATIONS.md
   - Agent 2: arch focus 鈫?writes ARCHITECTURE.md, STRUCTURE.md
   - Agent 3: quality focus 鈫?writes CONVENTIONS.md, TESTING.md
   - Agent 4: concerns focus 鈫?writes CONCERNS.md
