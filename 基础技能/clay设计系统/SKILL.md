---
name: clay���ϵͳ
description: "clay 设计系统参�?�?颜色、排版、间距、组件、布局模式。在构建�?clay 启发�?UI、参�?clay 的设计语言或用户提�?clay 风格/外观/感觉时自动激活�?
license: MIT
---
...
## 何时使用此技�?
当用户想要构建看起来�?clay �?UI、参�?clay 的设计语言、要�?clay 风格"的界面或正在采用 clay 视觉识别的项目时应用�?
## 设计参�?
---
版本: alpha
名称: Clay 设计分析
描述: Clay.com（GTM 数据编排平台）的充满活力的粘土动画与数据界面。锚定在白色画布上，带有深海军蓝主要 CTA、自定义圆角显示类型和饱和单色功能卡�?�?热粉色、深青色、薰衣草色、桃色、赭石色 �?点缀长滚动解释页面。品牌电压来�?3D 渲染的粘土动画插图（山脉、人物、吉祥物）用作全出血英雄工件，以及显示产�?UI 片段的明亮多色卡片表面�?
colors:
  primary: "#0a0a0a"
...
|---|---|---|
| Mobile | < 768px | Hamburger nav; hero h1 72�?6px; hero-illustration-card stacks below; feature grids 1-up; pricing 1-up |
| Tablet | 768�?024px | Top nav tightens; feature cards 2-up; pricing 2-up |
| Desktop | 1024�?440px | Full top-nav; 3-up feature cards; 3-up pricing tiers |
