---
name: GSD文档摄入
description: "从仓库中现有的ADRs、PRDs、SPECs和文档引导或合并.planning/设置"
...
<objective>
Build the full `.planning/` setup (or merge into an existing one) from multiple pre-existing planning documents 鈥?ADRs, PRDs, SPECs, DOCs 鈥?in one pass.
