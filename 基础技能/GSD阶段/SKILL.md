---
name: GSD½×¶Î
description: "ROADMAP.mdÖÐ½×¶ÎµÄCRUD¡ª¡ªÌí¼Ó¡¢²åÈë¡¢É¾³ý»ò±à¼­½×¶Î"
...
Mode routing:
- **default** (no flag): Add a new integer phase to the end of the current milestone ¡ú add-phase workflow
- **--insert**: Insert urgent work as a decimal phase (e.g., 72.1) between existing phases ¡ú insert-phase workflow
- **--remove**: Remove a future phase and renumber subsequent phases ¡ú remove-phase workflow
- **--edit**: Edit any field of an existing phase in place ¡ú edit-phase workflow
</objective>
