---
name: bugatti���ϵͳ
description: "bugatti 设计系统参�?�?颜色、排版、间距、组件、布局模式。在构建�?bugatti 启发�?UI、参�?bugatti 的设计语言或用户提�?bugatti 风格/外观/感觉时自动激活�?
license: MIT
---
...
## 何时使用此技�?
当用户想要构建看起来�?bugatti �?UI、参�?bugatti 的设计语言、要�?bugatti 风格"的界面或正在采用 bugatti 视觉识别的项目时应用�?
## 设计参�?
---
版本: alpha
名称: Bugatti 设计分析
描述: 一个朴素的豪华汽车界面，使用近纯黑色画布、白色大写字母间距显示和全出血汽车摄影作为唯一电压。系统运行三种自定义 Bugatti 字体 �?Bugatti Display、Bugatti Text Regular �?Bugatti Monospace �?并以适中的权重和宽跟踪组合它们，感觉欧洲工程化、超极简和安静昂贵。没有强调色、没有装饰元素、没有铬 �?只有摄影、排版和品牌标志�?
colors:
  primary: "#ffffff"
  ink: "#ffffff"
  body: "#cccccc"
...
|---|---|---|
| Mobile | < 768px | Hamburger nav; hero h1 64�?2px; career callout card hides; photo bands stay full-bleed; footer 4 cols �?1 |
| Tablet | 768�?024px | Top nav stays minimal (MENU + wordmark + STORE); 2-up newsroom grid; career rows full-width |
| Desktop | 1024�?440px | Full minimal top-nav; 2-up newsroom grid; spec tables 4-up |
