---
name: ��ѧ�õ�Ƭ
description: 为研究演讲构建幻灯片和演示文稿。用于制作PowerPoint幻灯片、会议演示、研讨会报告、研究报告、论文答辩幻灯片或任何科学演讲。提供幻灯片结构、设计模板、时间指导和视觉验证。支持PowerPoint和LaTeX Beamer�?allowed-tools: Read Write Edit Bash
license: MIT license
metadata:
  version: "1.0"
...
- All text readable (�?8pt equivalent)
- Adequate contrast (�?.5:1)
...
- [ ] One main idea per slide
- [ ] Font sizes �?8pt (preferably 24pt+)
