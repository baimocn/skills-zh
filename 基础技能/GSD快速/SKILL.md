---
name: GSD����
description: "ʹ��GSD��֤��ԭ���ύ��״̬���٣�ִ�п�������������ѡ����"
...
- Derive display status:
  ...
  - SUMMARY.md missing, dir created �? days ago �?`abandoned? (>7 days, no summary)`
...
auth-token-refresh-fix         2026-04-09  complete �?update-node-deps               2026-04-08  abandoned? (>7 days, no summary)
────────────────────────────────────────────────────────────
