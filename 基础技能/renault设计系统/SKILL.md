---
name: renault设计系统
description: "renault 设计系统参考 — 颜色、排版、间距、组件、布局模式。在构建受 renault 启发的 UI、参考 renault 的设计语言或用户提到 renault 风格/外观/感觉时自动激活。"
license: MIT
---
...
当用户想要构建看起来像 renault 的 UI、参考 renault 的设计语言、要求"renault 风格"的界面或正在采用 renault 视觉识别的项目时应用。
...
名称: Renault 设计分析
描述: |
  Renault 的网络存在将新现代化的 Renault 钻石（2021 年平面菱形标志）与鲜明的黑白画布配对，
