---
name: replicate设计系统
description: "replicate 设计系统参考 — 颜色、排版、间距、组件、布局模式。在构建受 replicate 启发的 UI、参考 replicate 的设计语言或用户提到 replicate 风格/外观/感觉时自动激活。"
license: MIT
---
...
当用户想要构建看起来像 replicate 的 UI、参考 replicate 的设计语言、要求"replicate 风格"的界面或正在采用 replicate 视觉识别的项目时应用。
...
名称: Replicate 设计分析
描述: |
  Replicate 的营销表面将独立 ML 游乐场的温暖奶油开发者工具美学与自信的热橙色品牌强调配对，
