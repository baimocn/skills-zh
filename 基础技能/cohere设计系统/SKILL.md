---
name: cohere���ϵͳ
description: "cohere 设计系统参�?�?颜色、排版、间距、组件、布局模式。在构建�?cohere 启发�?UI、参�?cohere 的设计语言或用户提�?cohere 风格/外观/感觉时自动激活�?
license: MIT
---
...
## 何时使用此技�?
当用户想要构建看起来�?cohere �?UI、参�?cohere 的设计语言、要�?cohere 风格"的界面或正在采用 cohere 视觉识别的项目时应用�?
## 设计参�?
---
版本: alpha
名称: Cohere 设计分析
描述: Cohere �?2026 Web 系统是一个受控的企业 AI 界面，由鲜明的白色编辑空间、深绿黑色产品条、柔和矿物表面、圆角媒体卡片以及单间距感觉显示标题和精�?Unica77 UI 文本之间的独特类型分裂构建而成�?
colors:
  primary: "#17171c"
  cohere-black: "#000000"
  ink: "#212121"
