---
name: ������ʩ������������
description: '当需要生成基础设施即代码配置时使用。触发词�?创建 Terraform 配置"�?生成 CloudFormation 模板"�?编写 Pulumi 代码"�?AWS/GCP/Azure �?IaC"。为 Terraform、CloudFormation、Pulumi、ARM 模板�?CDK 生成生产就绪的代码，支持多云提供商�?
  '
